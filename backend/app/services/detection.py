"""
Person detection service using AWS Lambda with YOLO.
Sends frames to Lambda and receives detection results.
"""
...
def detect_person_lambda(frame) -> bool:
    """
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if person_detected:
                ...
                print(f"Person detected! ({num_detections} detections)")
